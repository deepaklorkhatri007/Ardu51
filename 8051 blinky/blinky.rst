      ...
      000003 02 00 62         [24]  301 	ljmp	_main
                                    ...
                                    309 ;------------------------------------------------------------
                                    310 ;	blinky.c:11: void main(void){
                                    311 ;	-----------------------------------------
                                    312 ;	 function main
                                    313 ;	-----------------------------------------
      000062                        314 _main:
                           ...
                           000001   321 	ar1 = 0x01
                           000000   322 	ar0 = 0x00
                                    323 ;	blinky.c:13: while(1){
      000062                        324 00102$:
                                    325 ;	blinky.c:17: P1_0 = 1; //turn on the pin
                                    326 ;	assignBit
      000062 D2 90            [12]  327 	setb	_P1_0
                                    328 ;	blinky.c:19: delay();
      000064 12 00 6E         [24]  329 	lcall	_delay
                                    330 ;	blinky.c:20: P1_0 = 0; // turn off the pin
                                    331 ;	assignBit
      000067 C2 90            [12]  332 	clr	_P1_0
                                    333 ;	blinky.c:22: delay();
      ...
      00006C 80 F4            [24]  336 	sjmp	00102$
                                    ...
                                    342 ;------------------------------------------------------------
                                    343 ;	blinky.c:27: void delay(void){
                                    344 ;	-----------------------------------------
                                    345 ;	 function delay
                                    346 ;	-----------------------------------------
      00006E                        347 _delay:
                                    348 ;	blinky.c:34: for(i=0;i<0xff;i++) //outer loop 0-255
      00006E 7E 00            [12]  349 	mov	r6,#0x00
      000070 7F 00            [12]  350 	mov	r7,#0x00
      000072                        351 00106$:
                                    352 ;	blinky.c:35: for(j=0;j<0xff;j++); // inner loop 0-255
      000072 7C FF            [12]  353 	mov	r4,#0xff
      000074 7D 00            [12]  354 	mov	r5,#0x00
      000076                        355 00105$:
      000076 EC               [12]  356 	mov	a,r4
      000077 24 FF            [12]  357 	add	a,#0xff
      000079 FA               [12]  358 	mov	r2,a
      00007A ED               [12]  359 	mov	a,r5
      00007B 34 FF            [12]  360 	addc	a,#0xff
      00007D FB               [12]  361 	mov	r3,a
      00007E 8A 04            [24]  362 	mov	ar4,r2
      000080 8B 05            [24]  363 	mov	ar5,r3
      000082 EA               [12]  364 	mov	a,r2
      000083 4B               [12]  365 	orl	a,r3
      000084 70 F0            [24]  366 	jnz	00105$
                                    367 ;	blinky.c:34: for(i=0;i<0xff;i++) //outer loop 0-255
      000086 0E               [12]  368 	inc	r6
      000087 BE 00 01         [24]  369 	cjne	r6,#0x00,00121$
      00008A 0F               [12]  370 	inc	r7
      00008B                        371 00121$:
      00008B C3               [12]  372 	clr	c
      00008C EE               [12]  373 	mov	a,r6
      00008D 94 FF            [12]  374 	subb	a,#0xff
      00008F EF               [12]  375 	mov	a,r7
      000090 64 80            [12]  376 	xrl	a,#0x80
      000092 94 80            [12]  377 	subb	a,#0x80
      000094 40 DC            [24]  378 	jc	00106$
                                    379 ;	blinky.c:36: }
      000096 22               [24]  380 	ret
                                    381 	.area CSEG    (CODE)
                                    382 	.area CONST   (CODE)
                                    383 	.area XINIT   (CODE)
